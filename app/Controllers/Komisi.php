...
class Komisi extends BaseController
{
    ...
    function monthly()
    {
        ...
        $q2 = "SELECT x_jobgroup as x_job, sum(x_on_time_total_amount_2) as x_on_time_total_amount,
sum(x_late_total_amount_2) as x_late_total_amount, 
sum(x_unpaid_total_amount_2) as x_unpaid_total_amount, 

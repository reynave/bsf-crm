...
@Component({
  selector: 'app-approval-top',
  templateUrl: './approval-top.component.html',
  styleUrls: ['./approval-top.component.css']
})
export class ApprovalTopComponent   implements OnInit {
  items: any = [];
  ...
  httpGet() {
    this.loading = true;
    this.http.get<any>(environment.api + this.configService.getAppCode() + "ApprovalTop/index", {

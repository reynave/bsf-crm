...
@Component({
  selector: 'app-approval-ar-due',
  templateUrl: './approval-ar-due.component.html',
  styleUrls: ['./approval-ar-due.component.css']
})
export class ApprovalArDueComponent   implements OnInit {
  items: any = [];
  ...
  httpGet() {
    this.loading = true;
    this.http.get<any>(environment.api + this.configService.getAppCode() + "ApprovalArDue/index", {
